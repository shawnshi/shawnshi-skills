...
> **Total Inventory: 39 Strategic Modules across 7 Domains**
...
|:--------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------|
| **[brainstorming](brainstorming/)**                     | 必须在实施前使用。通过结构化对话（第一性原理、权衡分析）将抽象想法转化为具体的设计规范。                            |
| **[FirstPrinciples](FirstPrinciples/)**                 | 第一性原理分析。用于第一性原理、基础本质、根本原因、拆解等场景。                                                    |
...
| **[multi-agent-writer](multi-agent-writer/)**                 | 顶级咨询级协作写作编排专家 (V9.0: 本地全自动化引擎)。融合金字塔原理、Ghost Deck 视觉逻辑、医疗行业注入以及去AI化清洗。 |
...
| 技能标识 (Directory)                                                            | 核心本质 (Essence & Mission)                                                                                                     |
|:--------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------|
| **[digital-health-lectures-scout](digital-health-lectures-scout/)**             | 医疗数字化战略侦察兵 (V3.0)。扫描医学核心期刊的前沿 AI 源始研究，执行技术脱水与成熟度判定，基于中国 DRG 实战重力场做商业推演。   |
| **[digital-health-weekly-brief](digital-health-weekly-brief/)**                 | 数字健康周报生成器 (V2.0)。检索顶尖咨询机构本周发布的医疗数字化研报，运用 S-I-A 框架提取战略信号并评估其对行业护城河的降维冲击。 |
| **[healthcare-digital-strategy-partner](healthcare-digital-strategy-partner/)** | 顶级医疗数字化战略与行业研究专家智能体 (V15.0)。融合MBB咨询框架与医疗IT深水区认知，动词驱动叙事，强制双轨ROI验证。               |
| **[healthcare-industry-radar](healthcare-industry-radar/)**                     | 医疗行业战略雷达 (V3.0)。侦察捕获本周核心 HIT 巨头异动与医药资本动态，运用 S-T-C 模型进行穿透性护城河透视并给出卫宁反击指令。    |
| **[medical-solution-architect](medical-solution-architect/)**                   | 顶级医疗数字化转型与IT架构设计专家 (V6.0)。交付具备“临床价值、信创合规、数据资产确权、TCO最优、技术可演进”的落地方案。           |
...
| 技能标识 (Directory)                              | 核心本质 (Essence & Mission)                                                                              |
|:--------------------------------------------------|:----------------------------------------------------------------------------------------------------------|
| **[marketing-psychology](marketing-psychology/)** | 将心理学原理、心智模型或行为科学应用于营销。提供 70+ 种经过整理可直接应用的心智武器库。                   |
| **[marketing-strategy](marketing-strategy/)**     | 搭载审计驱动、战术注射与动态 LTV 增长框架的 AI 首席营销官。深度重构为卫宁健康医疗信息化专属战略咨询引擎。 |
| **[pricing-strategy](pricing-strategy/)**         | 协助制定定价决策、组合打包或变现策略。涵盖定价研究、层级解构及组合策略。                                  |
| **[yahoo-finance](yahoo-finance/)**               | 获取股票价格、基本面、新闻及历史趋势。支持多代码查询、自然语言日期解析、日内K线间隔及结构化 JSON 输出。   |
...
| 技能标识 (Directory)                                        | 核心本质 (Essence & Mission)                                                                                                                    |
|:------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------|
| **[auditingdiary](auditingdiary/)**                         | 管理个人日记条目，并使用结构化提示词进行认知审计（周/月/年度复盘）。                                                                            |
| **[garmin-health-analysis](garmin-health-analysis/)**       | 私人首席医疗官(CMO)与生理战略引擎。基于客观数据执行全链路深度审计，管理高阶决策准备度与系统性战略风险。                                         |
| **[monthly-personal-insights](monthly-personal-insights/)** | 运用“多面体分析”审计 30 天表现的战略元分析器，旨在解码用户与 AI 的交互协作模式。                                                                |
| **[musicbee-dj](musicbee-dj/)**                             | AI 驻场环境音策展人。基于 GEB-Flow 构建的 JIT 歌单引擎，通过解析 iTunes XML 并运用 DJ 心理学算法(BPM控制、熟识度配比)全自动接管本地心流背景音。 |
...
| 技能标识 (Directory)                            | 核心本质 (Essence & Mission)                                                                         |
|:------------------------------------------------|:-----------------------------------------------------------------------------------------------------|
| **[document-summarizer](document-summarizer/)** | 批量总结 PDF/DOCX/PPTX/XLSX 文件，附带智能中文摘要和标签体系。                                       |
| **[docx](docx/)**                               | 创建、读取、编辑或操作 Word 文档（.docx 文件）。生成带格式排版的高级专业文档。                       |
| **[excel-pro](excel-pro/)**                     | 重装级 Excel 治理系统。整合物理层 XML 操纵与逻辑层数据建模，实现从数据摄取到专业模型固化的全栈闭环。 |
...
---
*Last Global Audit: 2026-03-04 | System State: Optimized*
