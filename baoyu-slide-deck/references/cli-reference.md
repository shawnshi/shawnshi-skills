...
| Command | Purpose |
|---------|---------|
| `/baoyu-slide-deck path/to/content.md --outline-only` | Only generate `outline.md` for review. |
| `/baoyu-slide-deck path/to/content.md --prompts-only` | Generate prompts but do not call image API. |
| `/baoyu-slide-deck slide-deck/topic-slug/ --images-only` | Resume image generation from existing prompts. |
| `/baoyu-slide-deck slide-deck/topic-slug/ --regenerate 3,5` | Specific slide regeneration. |
