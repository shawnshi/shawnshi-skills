...
若当前主题为医疗数字化、智慧医院或参加 CHIMA/HIMSS 等行业会议，必须叠加以下约束：
1. **[底层逻辑]**: 放弃 C 端互联网的流量叙事。所有价值推演必须落在：**临床质控、患者安全、医护减负、医院运营降本增效、以及评级过审（如电子病历、互联互通评级）**上。
2. **[视觉底盘]**: 彻底摒弃“发光大脑”、“全息地球”等空洞的伪科技感配图。强制要求使用真实的**临床业务拓扑图**、**数据治理流向图 (Data Lineage)** 或 **高密度 ROI 数据对比仪表盘**。
3. **[用词脱水]**: 严禁使用“赋能”、“颠覆”、“引爆”等互联网黑话。强制切换为临床与架构专业术语，如：“全院级数据湖底座”、“互联互通标准化体系”、“临床决策辅助 (CDSS)”、“专科闭环管理”。
...
- **外行黑话症**：在严肃的医疗/企业级场景下，使用“降维打击”、“生态赋能”等非临床/非架构规范术语。
