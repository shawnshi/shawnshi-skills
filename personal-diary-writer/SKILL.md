...
metadata:
  version: "11.6.1-proxy"
  authority_proxy_for: C:/Users/shich/.gemini/config/skills/personal-diary-writer/SKILL.md
  authority_version: "11.6.1"
  authority_sha256: 77dd7cd5680b30284beed85949a706f5d6645146753488b7b730351217568dc8
---
...
- 默认读取授权不包含 Garmin 登录、令牌创建或刷新写入、绕过新鲜度门的本地数据库同步、同步任务注册/更新、原始活动文件下载、账户资料、设备闹钟、日历写操作或任何第二处持久化；仅允许一次 canonical 两阶段直同步。
