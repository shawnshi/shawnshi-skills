"""
<!-- Input: Script Name, Script Arguments -->
<!-- Output: Execution Result within Isolated VirtualEnv -->
<!-- Pos: scripts/run.py. Central Orchestrator and Environment Manager. -->

!!! Maintenance Protocol: This is the ONLY entry point for the skill.
!!! It handles automatic .venv creation and dependency injection.
"""
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("  generate_asset.py   - Generate Slide Decks or Infographics")
