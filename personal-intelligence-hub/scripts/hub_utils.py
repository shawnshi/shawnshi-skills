...
def run_llm(prompt: str, fallback_used: bool = False) -> str:
    ...
    # SECURITY: Using shell=False with shlex.split() to prevent command injection
    # vulnerabilities, particularly when executing user-provided environment variables.
