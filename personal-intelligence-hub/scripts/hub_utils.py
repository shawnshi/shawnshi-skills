...
def run_llm(prompt: str) -> str:
    ...
    # Prevent command injection by splitting the command into a list and not using a shell
    # Security concern: The PIH_LLM_COMMAND env variable is unsanitized user input
