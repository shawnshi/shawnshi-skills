...
# Cognitive Morphism Mapper (The Category Theorist)
...
- JSON 结构：`{"skill_name": "cognitive-morphism-mapper", "status": "success", "duration_sec": [ESTIMATE], "input_tokens": [ESTIMATE], "output_tokens": [ESTIMATE]}`
