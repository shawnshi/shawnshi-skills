...
2. **Delegation**: Explicitly invoke a sub-agent (e.g., `generalist` or a dedicated parser) to consume the packet, perform the heavy document ingestion, and write the structured summary back to a designated result file.
