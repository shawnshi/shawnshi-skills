...
description: Batch summarize PDF/DOCX/PPTX/XLSX files with intelligent Chinese summaries and tags. Use when user asks to "summarize documents", "audit portfolio", "check compliance", or "tag medical files".
---
