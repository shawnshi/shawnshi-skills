...
description: 个人认知审计与日志治理专家。当用户要求“复盘今日日志”、“提取认知盲点”、“评估交互价值”或需要“周/月/年度审计报告”时，务必激活。该技能通过结构化提示词对个人记录执行深层审计，强制执行防跳步审计流与物理数据锁。
...
# Personal Diary Auditing (Strategic Architect Edition)
