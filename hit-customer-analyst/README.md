...
医疗卫生信息化售前客户研究与重要拜访准备技能，当前为 **2.6.2 独立候选／限定内部试用**。入口规则见 [SKILL.md](SKILL.md)，前期工程证据见 [审计报告](AUDIT-2026-09-07.md)，本次整改及交付边界见 [候选交付说明](DELIVERY-CANDIDATE-2026-09-07.md)。
