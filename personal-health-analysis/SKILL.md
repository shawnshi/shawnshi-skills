...
# Personal Health Analysis (CMO Level V8.1 Native)
...
- **单项指标 (Level 1)**: `... python "C:\Users\shich\.gemini\config\skills\personal-health-analysis\scripts\garmin_data.py" [sleep|hrv|heart_rate|body_battery|stress] --days 7`
- **综合摘要 (Level 2)**: `... python "C:\Users\shich\.gemini\config\skills\personal-health-analysis\scripts\garmin_data.py" summary --days 7`
...
- **长程战略 (90天/热力图)**: 强制调用 `garmin_chart.py` 生成大屏：
  ...
  （HTML大屏链接必须以绝对物理路径返回给用户：`[查看生物态势看板](file:///C:/Users/shich/.gemini/MEMORY/raw/garmin/tactical_board_...)`）
