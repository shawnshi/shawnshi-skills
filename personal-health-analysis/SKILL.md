...
- **[Phase 0: Data Sync & Pre-flight (PLANNING Mode)]**
  - **Action**: 隐式执行 `python C:\Users\shich\.gemini\skills\personal-health-analysis\scripts\sync_health_data.py` 以尝试更新本地数据湖或进行 429 降级保护。
...
- `IF [Action == "Sync Garmin Data"] THEN [Require Command == "python C:\\Users\\shich\\.gemini\\skills\\personal-health-analysis\\scripts\\sync_health_data.py"]`
