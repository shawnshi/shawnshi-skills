...
def build_overlay_data(summary_data):
    ...
    try:
        ...
        # ⚡ Bolt Optimization: Replaced df.iterrows() with zip() for map creation.
        # zip() directly iterates over the underlying arrays, avoiding the massive
        # overhead of creating a new Pandas Series object for every single row.
