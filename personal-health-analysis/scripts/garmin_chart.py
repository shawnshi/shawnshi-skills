...
def build_overlay_data(summary_data):
    ...
    try:
        ...
        # Performance: Replace iterrows() with zip() for vectorized iteration, which avoids instantiating new Series objects for each row and significantly improves performance.
