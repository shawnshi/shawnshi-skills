...
def build_overlay_data(summary_data):
    ...
    try:
        ...
        # Performance Optimization: Replaced df.iterrows() with zip() for dictionary comprehensions.
        # zip() directly iterates over underlying NumPy arrays, avoiding the overhead of creating new Series objects in each iteration.
