...
Structure for user preferences in `.baoyu-skills/slide-deck/EXTEND.md`.
...
1. `.baoyu-skills/slide-deck/EXTEND.md` (project)
2. `$HOME/.baoyu-skills/slide-deck/EXTEND.md` (user)
