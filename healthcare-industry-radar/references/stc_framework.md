# The S-T-C Framework & Target Definitions

This reference document defines the specific target lists, keyword filters, and the rigid analytical framework governing the `healthcare-industry-radar` skill.
...
1. **The EHR Foundation Defenders (底层电子病历老玩家)**:
   ...
   - 卫宁健康(Winning Health), 东软集团(Neusoft), 东华医为(Donghua Medical), 创业慧康(B-Soft).
