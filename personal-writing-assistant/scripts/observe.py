...
def _detect_base():
    ...
    # Mentat 物理主权：强制使用本地 MEMORY 路径
    return Path("C:/Users/shich/.gemini/MEMORY")

DEFAULT_LOG_DIR = _detect_base() / "skill_audit" / "style_runs" / "personal-writing-assistant"
...
def get_log_dir(args=None):
    ...
    if args and hasattr(args, 'log_dir') and args.log_dir:
        ...
        d = _detect_base() / "skill_audit" / "style_runs" / skill_name
    else:
        d = DEFAULT_LOG_DIR
