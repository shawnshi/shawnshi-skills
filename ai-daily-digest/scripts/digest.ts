...
Options:
  ...
  --raw           Output raw filtered articles as JSON to stdout (skips AI processing)
  --help          Show this help

Environment:
  GEMINI_API_KEY  Required for AI processing (not needed with --raw)

Examples:
  bun scripts/digest.ts --hours 24 --raw
  bun scripts/digest.ts --hours 48 --top-n 10 --lang zh
`);
  process.exit(0);
}
