...
```bash
npx skills add https://github.com/op7418/tool-web-slide --skill tool-web-slide
```

### Option 2: Paste this to an AI

> Install the `tool-web-slide` Claude Code skill for me. Steps:
>
> 1. Make sure `~/.claude/skills/` exists (create if not)
> 2. Run `git clone https://github.com/op7418/tool-web-slide.git ~/.claude/skills/tool-web-slide`
> 3. Verify: `ls ~/.claude/skills/tool-web-slide/` should show `SKILL.md`, `assets/`, `references/`
...
```bash
git clone https://github.com/op7418/tool-web-slide.git ~/.claude/skills/tool-web-slide
```
