...
> 帮我安装 `tool-web-slide` 这个 Claude Code skill。请按下面步骤做:
>
> 1. 确保 `~/.claude/skills/` 目录存在(不存在就创建)
> 2. 执行 `git clone https://github.com/op7418/tool-web-slide.git ~/.claude/skills/tool-web-slide`
> 3. 验证:`ls ~/.claude/skills/tool-web-slide/` 应该看到 `SKILL.md`、`assets/`、`references/` 三项
